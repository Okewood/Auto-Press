...
switch($_REQUEST['section_id']) {
	case 1: 
		...
		break;
	case 2: 
		$heading = 'th_motorsport.gif';
		break;
	case 3:
		$heading = 'th_goodwood.gif';
		break;
	case 4:
		$heading = 'th_marine.gif';
		break;
}
...
$th = (isset($_REQUEST['th']) ? $_REQUEST['th']+1 : 1);
...
<div id="text" style="margin-left:auto; margin-right:auto; width:540px;">
	<table cellpadding="0" cellspacing="0" style="margin-left:auto; margin-right:auto; width:100%;">
		<tr>
			...
			<td style="padding-bottom:10px; border-bottom:1px solid #FFFF00; text-align:right; vertical-align:bottom;"><a href="Javascript:history.go(-<?php echo $th ?>)"><img src="design/buttons/btn_back.jpg" border="0"></a> <a href="gallery_large.php?section_id=<?php echo $_REQUEST['section_id'] ?>&category_id=<?php echo $_REQUEST['category_id'] ?>&image_array_no=<?php echo ($_REQUEST['image_array_no']==0 ? (count($_SESSION['image_array'])-1) : $_REQUEST['image_array_no']-1 ); ?>&th=<?php echo $th ?>"><img src="design/buttons/btn_previous.jpg" border="0"></a>&nbsp;&nbsp;<a href="gallery_large.php?section_id=<?php echo $_REQUEST['section_id'] ?>&category_id=<?php echo $_REQUEST['category_id'] ?>&image_array_no=<?php echo ($_REQUEST['image_array_no']==(count($_SESSION['image_array'])-1) ? 0 : $_REQUEST['image_array_no']+1 ); ?>&th=<?php echo $th ?>"><img src="design/buttons/btn_next.jpg" border="0"></a></td>
		</tr>
		<tr>
		...
		<tr align="left">
			...
			<td style="padding-top:10px;"><?php echo substr($row['file_name'],0,-4) ?></td>
		</tr>
    </table>
</div>
<?php
